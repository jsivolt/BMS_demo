...
#define LPSPI_IP_SA_SW_PATCH_VERSION_PBCFG_C                 1
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_1 =
{
    ...
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
        ...
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U)), /* ccr */
        (uint32)(LPSPI_CCR1_SCKSCK(38U) | LPSPI_CCR1_PCSPCS(19U) | LPSPI_CCR1_SCKHLD(19U) | LPSPI_CCR1_SCKSET(19U)), /* ccr1 */
