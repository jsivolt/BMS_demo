...
#define PIT_IP_AR_RELEASE_MINOR_VERSION_C     9
#define PIT_IP_AR_RELEASE_REVISION_VERSION_C  0
#define PIT_IP_SW_MAJOR_VERSION_C             7
#define PIT_IP_SW_MINOR_VERSION_C             0
#define PIT_IP_SW_PATCH_VERSION_C             1
...
#include "Gpt_MemMap.h"
        ...
        defined(CPE_PIT_0_CH_0_ISR_USED) || defined(CPE_PIT_0_CH_1_ISR_USED) || \
        defined(CPE_PIT_0_CH_2_ISR_USED) || defined(CPE_PIT_0_CH_3_ISR_USED) || \
        defined(CPE_PIT_1_CH_0_ISR_USED) || defined(CPE_PIT_1_CH_1_ISR_USED) || \
        defined(CPE_PIT_1_CH_2_ISR_USED) || defined(CPE_PIT_1_CH_3_ISR_USED) || \
        defined(LPE_PIT_RTI_ISR_USED) || \
        defined(COSS_PIT_0_ISR_USED) || defined(COSS_PIT_1_ISR_USED) || \
        defined(COSS_PIT_2_ISR_USED) || defined(COSS_PIT_3_ISR_USED) || \
        defined(COSS_PIT_4_ISR_USED) || defined(COSS_PIT_5_ISR_USED) || defined(COSS_PIT_6_ISR_USED) || \
        defined(RCU_PIT_0_ISR_USED) || defined(RCU_PIT_1_ISR_USED) || defined(RCU_PIT_2_ISR_USED) || \
        defined(RCU_PIT_3_ISR_USED) || defined(RCU_PIT_4_ISR_USED) || defined(RCU_PIT_5_ISR_USED) || \
        defined(RCU_PIT_6_ISR_USED) || defined(RCU_PIT_7_ISR_USED) || defined(RCU_PIT_8_ISR_USED) || \
        defined(RCU_PIT_9_ISR_USED) || defined(RCU_PIT_10_ISR_USED) || defined(RCU_PIT_11_ISR_USED) || \
        defined(RCU_PIT_12_ISR_USED) || defined(RCU_PIT_13_ISR_USED) || \
        ...
        defined(FSS_COSS_PIT_6_ISR_USED) || defined(FSS_HKI_PIT_0_ISR_USED) || \
        defined(FSS_PIT_0_CH_0_ISR_USED) || defined(FSS_PIT_0_CH_1_ISR_USED) || defined(FSS_PIT_0_CH_2_ISR_USED) || \
        defined(FSS_PIT_1_CH_0_ISR_USED) || defined(FSS_PIT_1_CH_1_ISR_USED) || \
        defined(FSS_PIT_2_CH_0_ISR_USED) || defined(FSS_PIT_2_CH_1_ISR_USED) || \
        defined(FSS_PIT_3_CH_0_ISR_USED) || defined(FSS_PIT_3_CH_1_ISR_USED) )
...
static inline void Pit_Ip_SetModuleDisableFlag(uint8 instance, uint8 timerType, boolean aboEn);
#endif
...
* @implements    Pit_Ip_GetLoadValue_Activity
*/
...
#if (defined(PIT_IP_MDIS_BIT_EXISTS) && (PIT_IP_MDIS_BIT_EXISTS == STD_ON))
/**
 * @brief       Pit_Ip_SetModuleDisableFlag
 * @details     Enable/disable the PIT module
 *      Disables the standard timers. You must disable the clock (write 1 to MDIS) before configuring PIT.
 *      After configuration, you must enable the clock (write 0 to MDIS).
 *          0b - Enables
 *          1b - Disables
 *
 * @param[in]   instance    PIT hw instance number
 * @param[in]   timerType   type of timer
 * @param[in]   aboEn       Enable/disable the PIT module.
 *
 *  @return     void
 *  @pre        The driver needs to be initialized.
 */
static inline void Pit_Ip_SetModuleDisableFlag(uint8 instance, uint8 timerType, boolean aboEn)
{
    if (0U == timerType)
    {
        pitBase[instance]->MCR = (pitBase[instance]->MCR & ~(PIT_MCR_MDIS_MASK)) | PIT_MCR_MDIS((TRUE == aboEn) ?  1UL : 0UL);
    }
#if (defined(PIT_IP_RTI_USED) && (PIT_IP_RTI_USED == STD_ON))
    else
    {
        pitBase[instance]->MCR = (pitBase[instance]->MCR & ~(PIT_MCR_MDIS_RTI_MASK)) | PIT_MCR_MDIS_RTI((TRUE == aboEn) ?  1UL : 0UL);
    }
#endif
}
#endif
...
static inline boolean Pit_Ip_IsChannelRunning(uint8 instance, uint8 channel)
{
    ...
    if (RTI == channel)
    {
        isRunning = (0U != (pitBase[instance]->RTI_TCTRL & PIT_RTI_TCTRL_TEN_MASK)) ? TRUE : FALSE;
    }
    else
#endif
    {
        isRunning = (0U != (pitBase[instance]->TIMER[channel].TCTRL & PIT_TCTRL_TEN_MASK)) ? TRUE : FALSE;
    }
    return isRunning;
}
...
static inline uint32 Pit_Ip_GetUpperLifetimerValue(uint8 instance)
{
    return pitBase[instance]->LTMR64H;
}
/**
...
static inline uint32 Pit_Ip_GetLowerLifetimerValue(uint8 instance)
{
    return pitBase[instance]->LTMR64L;
}
#if (defined(PIT_IP_RTI_USED) && (PIT_IP_RTI_USED == STD_ON))
/**
 ...
 * @pre The driver needs to be initialized.
 * @implements    Pit_Ip_GetInterruptStatusFlag_Activity
 */
...
void Pit_Ip_Init(uint8 instance, const Pit_Ip_InstanceConfigType *config)
{
    ...
    if(PIT_AE_IP_INSTANCE_NUMBER != instance)
    {
        ...
        {
            /* Enable PIT Module (write 0 to MCR[MDIS]) */
            Pit_Ip_SetModuleDisableFlag(instance, 0U, FALSE);
        }
#if (defined(PIT_IP_RTI_USED) && (PIT_IP_RTI_USED == STD_ON))
        ...
        {
            /* Enable PIT Module (write 0 to MCR[MDIS]) */
            Pit_Ip_SetModuleDisableFlag(instance, 1U, FALSE);
        }
#endif
#if (defined(GPT_PIT_AE_REG_PROT_AVAILABLE) && (STD_ON == GPT_PIT_AE_REG_PROT_AVAILABLE))
    }
...
void Pit_Ip_Deinit(uint8 instance)
{
    ...
    switch (instance)
    {
...
#ifdef PIT_IP_RTI_CHANNEL_EXISTS
#if (defined(PIT_IP_RTI_INSTANCE_NUM) && (PIT_IP_RTI_INSTANCE_NUM == PIT_0_IP_INSTANCE_NUMBER))
        ...
        break;
#endif
#ifdef CPE_PIT_0_IP_EXISTS
        case CPE_PIT_0_IP_INSTANCE_NUMBER:
            channelNum = CPE_PIT_0_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef CPE_PIT_1_IP_EXISTS
        case CPE_PIT_1_IP_INSTANCE_NUMBER:
            channelNum = CPE_PIT_1_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef LPE_PIT_RTI_IP_EXISTS
        case LPE_PIT_RTI_IP_INSTANCE_NUMBER:
            channelNum = LPE_PIT_RTI_IP_CHANNELS_NUMBER;
#ifdef PIT_IP_RTI_CHANNEL_EXISTS
#if (defined(PIT_IP_RTI_INSTANCE_NUM) && (PIT_IP_RTI_INSTANCE_NUM == LPE_PIT_RTI_IP_INSTANCE_NUMBER))
            rtiChannelExists = TRUE;
#endif
#endif
        break;
        ...
        break;
#endif
#ifdef COSS_PIT_0_IP_EXISTS
        case COSS_PIT_0_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_0_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_1_IP_EXISTS
        case COSS_PIT_1_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_1_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_2_IP_EXISTS
        case COSS_PIT_2_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_2_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_3_IP_EXISTS
        case COSS_PIT_3_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_3_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_4_IP_EXISTS
        case COSS_PIT_4_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_4_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_5_IP_EXISTS
        case COSS_PIT_5_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_5_IP_CHANNELS_NUMBER;
        break;
#endif
#ifdef COSS_PIT_6_IP_EXISTS
        case COSS_PIT_6_IP_INSTANCE_NUMBER:
            channelNum = COSS_PIT_6_IP_CHANNELS_NUMBER;
        break;
#endif
...
#if (defined(PIT_IP_RTI_USED) && (PIT_IP_RTI_USED == STD_ON) && defined(PIT_IP_TIMEOUT_COUNTER))
    uint32 startTime, elapsedTime, timeoutTicks;
    Pit_Ip_StartTimeout(&startTime, &elapsedTime, &timeoutTicks, PIT_IP_TIMEOUT_COUNTER);
#endif

    boolean isRunning = Pit_Ip_IsChannelRunning(instance, channel);
...
uint64 Pit_Ip_GetCurrentTimer(uint8 instance, uint8 channel)
{
    ...
    DevAssert(PIT_CHANNEL_COUNT > channel);
#endif
    uint64 counterValue = Pit_Ip_GetCounterValue(instance, channel);
    return counterValue;
}
...
void Pit_Ip_SetLifetimeTimer(uint8 instance)
{
...
#if (defined(PIT_IP_MDIS_BIT_EXISTS) && (PIT_IP_MDIS_BIT_EXISTS == STD_ON))
    /* Disable PIT Module (write 1 to MCR[MDIS]) */
    Pit_Ip_SetModuleDisableFlag(instance, 0U, TRUE);
#endif

    /* Timer 1 */
    /* Stop timer channel 1 to configure channel */
    Pit_Ip_EnableTimer(instance, 1U, FALSE);
    /* Disable timer channel 1 Interrupts */
    Pit_Ip_SetEnableInterruptFlag(instance, 1U, FALSE);
    /* Clear pending interrupts */
    Pit_Ip_ClearInterruptStatusFlag(instance, 1U);
    ...
    /* Timer 0 */
    /* Stop timer channel 0 to configure channel */
    Pit_Ip_EnableTimer(instance, 0U, FALSE);
    /* Disable timer channel 0 Interrupts */
    Pit_Ip_SetEnableInterruptFlag(instance, 0U, FALSE);
    /* Clear pending interrupts */
    Pit_Ip_ClearInterruptStatusFlag(instance, 0U);
