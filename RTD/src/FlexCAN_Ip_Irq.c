 ...
 *  @details Contains the Interrupt Handlers implementation
 *
 *  @addtogroup FlexCAN
 *  @{
 */
...
#define FLEXCAN_IP_IRQ_AR_RELEASE_MINOR_VERSION_C       9
#define FLEXCAN_IP_IRQ_AR_RELEASE_REVISION_VERSION_C    0
#define FLEXCAN_IP_IRQ_SW_MAJOR_VERSION_C               7
#define FLEXCAN_IP_IRQ_SW_MINOR_VERSION_C               0
#define FLEXCAN_IP_IRQ_SW_PATCH_VERSION_C               1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
