...
#define ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_TYPES       9
#define ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_TYPES    0
#define ADC_SAR_IP_SW_MAJOR_VERSION_TYPES               7
...
/* Check if Adc_Sar_Ip_Types.h file and Std_Types.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Adc_Sar_Ip_Types.h and Std_Types.h are different"
#endif
...
typedef enum
{
    ADC_SAR_IP_CONV_CHAIN_NORMAL    = ADC_CDR_RESULT_NORMAL_TRIGGER,    /*!< Selects the "Normal" Conversion Chain */
    ADC_SAR_IP_CONV_CHAIN_INJECTED  = ADC_CDR_RESULT_INJECTED_TRIGGER,  /*!< Selects the "Injected" Conversion Chain */
    ADC_SAR_IP_CONV_CHAIN_CTU       = ADC_CDR_RESULT_CTU_TRIGGER        /*!< Selects the "CTU" Conversion Chain */
 ...
 */
typedef void Adc_Sar_Ip_WdgNotificationType(const uint16 ChanIdx, const uint32 Flags);
