...
*
*   @brief FlexCAN Ip Wrapper Header File
*   @details This Files Contains the FlexCAN Ip Wrapper declaration
*
*   @addtogroup FlexCAN
*   @{
*/
...
#define FLEXCAN_IP_WRAPPER_AR_RELEASE_MINOR_VERSION_H       9
#define FLEXCAN_IP_WRAPPER_AR_RELEASE_REVISION_VERSION_H    0
#define FLEXCAN_IP_WRAPPER_SW_MAJOR_VERSION_H               7
#define FLEXCAN_IP_WRAPPER_SW_MINOR_VERSION_H               0
#define FLEXCAN_IP_WRAPPER_SW_PATCH_VERSION_H               1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
