...
#define WKPU_IP_IRQ_AR_RELEASE_MINOR_VERSION       9
#define WKPU_IP_IRQ_AR_RELEASE_REVISION_VERSION    0
#define WKPU_IP_IRQ_SW_MAJOR_VERSION               7
#define WKPU_IP_IRQ_SW_MINOR_VERSION               0
#define WKPU_IP_IRQ_SW_PATCH_VERSION               1
...
/**
 * @brief        Interrupt handler for WKPU channels (single interrupt line)
 * @details      This is the main interrupt service routine for WKPU when all channels
 *               share a single interrupt line. The ISR calls Wkpu_Ip_ProcessSingleInterrupt
 *               to handle all pending interrupts from any WKPU channel.
 *               This ISR is only defined for platforms with WKPU_ICU_SINGLE_INTERRUPT enabled.
 *
 * @param        void
 *
 * @return       void
