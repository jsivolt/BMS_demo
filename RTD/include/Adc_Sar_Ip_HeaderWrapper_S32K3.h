...
#define ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_HEADERWRAPPER_S32K3       9
#define ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_HEADERWRAPPER_S32K3    0
#define ADC_SAR_IP_SW_MAJOR_VERSION_HEADERWRAPPER_S32K3               7
#define ADC_SAR_IP_SW_MINOR_VERSION_HEADERWRAPPER_S32K3               0
#define ADC_SAR_IP_SW_PATCH_VERSION_HEADERWRAPPER_S32K3               1

/*==================================================================================================
*                                       LOCAL FUNCTIONS
==================================================================================================*/
/* Register access function */
static inline volatile uint32* Adc_GetRegRefer(volatile uint32 reg_base[],
                                               uint32 regIndex)
{
    return &reg_base[regIndex];
}
...
#define ADC_SAR_IP_ABORTCHAIN_WORKAROUND                 (0U)
                                     ...
                                     /* 31-28   3-0  63-60  35-32 95-92  67-64
                                         \_/    \_/   \_/    \_/   \_/    \_/
                                          |......|     |......|     |......| */
#define ADC_SAR_IP_CHN_AVAIL_BITMAP   {{0x000000FFU, 0x004FFFFFU, 0xFFFFFFFFU}, /* 0 */ \
...
#define ADC_SAR_IP_MAX_CHN_COUNT      {{8U, 26U, 32U}, /* Adc HW Unit 0 */ \
                                     ...
                                     /* Unit 0 / 1 / 2 / 3 / 4 / 5 / 6 */
#define ADC_SAR_IP_MAX_GROUP_COUNT    { 3U, 3U, 2U, 2U, 2U, 2U, 2U }
                                     /* Bit0: DSDR is available
                                        Bit1: PSCR is available
                                        Bit2: CTU is available
                                        Bit3: CTU trigger mode is available */
#define ADC_SAR_IP_FEAT_AVAIL_BITMAP   {0x0000000FU, /* Adc HW Unit 0 */ \
...
#elif (ADC_SAR_IP_INSTANCE_COUNT == 4U)
                                       /* 31-28   3-0  63-60  35-32 95-92  67-64
                                           \_/    \_/   \_/    \_/   \_/    \_/
                                            |......|     |......|     |......| */
#define ADC_SAR_IP_CHN_AVAIL_BITMAP   {{0x000000FFU, 0x000F000FU, 0x00000000U}, /* 3 */ \
                                       {0x000000FFU, 0x000F000FU, 0x00000000U}, /* 4 */ \
                                       {0x000000FFU, 0x000F000FU, 0x00000000U}, /* 5 */ \
                                       {0x000000FFU, 0x000F000FU, 0x00000000U}, /* 6 */ \
                                      }
                                     ...
                                     /* There are some registers that relate to this one: CEOCFR, CIMR, DMAR, PSR, NCMR, JCMR,... */
                                     /* Should be same with ADC_CDRx_COUNT in header file (from Base) */
#define ADC_SAR_IP_MAX_CHN_COUNT      {{8U, 26U, 0U},  /* Adc HW Unit 3 */ \
                                       {8U, 26U, 0U},  /* Adc HW Unit 4 */ \
                                       {8U, 26U, 0U},  /* Adc HW Unit 5 */ \
                                       {8U, 26U, 0U},  /* Adc HW Unit 6 */ \
                                      }
                                     /* Number of group channels of each unit */
                                     /* Unit 3 / 4 / 5 / 6 */
#define ADC_SAR_IP_MAX_GROUP_COUNT    { 2U, 2U, 2U, 2U }
                                     /* Bit0: DSDR is available
                                        Bit1: PSCR is available
                                        Bit2: CTU is available
                                        Bit3: CTU trigger mode is available */
#define ADC_SAR_IP_FEAT_AVAIL_BITMAP   {0x0000000EU, /* Adc HW Unit 3 */ \
                                        0x0000000EU, /* Adc HW Unit 4 */ \
                                        0x0000000EU, /* Adc HW Unit 5 */ \
                                        0x0000000EU, /* Adc HW Unit 6 */ \
                                       }
                                     ...
                                     /* 31-28   3-0  63-60  35-32 95-92  67-64
                                         \_/    \_/   \_/    \_/   \_/    \_/
                                          |......|     |......|     |......| */
#define ADC_SAR_IP_CHN_AVAIL_BITMAP   {{0x000000FFU, 0x00C7FFFFU, 0xFFFFFFFFU}, /* 0 */ \
                                     ...
                                     /* There are some registers that relate to this one: CEOCFR, CIMR, DMAR, PSR, NCMR, JCMR,... */
                                     /* Should be same with ADC_CDRx_COUNT in header file (from Base) */
#define ADC_SAR_IP_MAX_CHN_COUNT      {{8U, 24U, 32U}, /* Adc HW Unit 0 */ \
                                       {8U, 24U, 32U}, /* Adc HW Unit 1 */ \
                                       {8U, 24U, 0U},  /* Adc HW Unit 2 */ \
                                      }
                                     /* Number of group channels of each unit */
                                     /* Unit 0 / 1 / 2 */
#define ADC_SAR_IP_MAX_GROUP_COUNT    { 3U, 3U, 2U }
                                     /* Bit0: DSDR is available
                                        Bit1: PSCR is available
                                        Bit2: CTU is available
                                        Bit3: CTU trigger mode is available */
...
#define ADC_SAR_IP_MAX_CHN_COUNT      {{8U, 24U, 32U}, /* Adc HW Unit 0 */ \
                                     ...
                                     /* Number of group channels of each unit */
                                     /* Unit 0 / 1 */
#define ADC_SAR_IP_MAX_GROUP_COUNT    { 3U, 3U }
                                     /* Bit0: DSDR is available
                                        Bit1: PSCR is available
                                        Bit2: CTU is available
                                        Bit3: CTU trigger mode is available */
...
#define CEOCFR(base, regIndex)      (*Adc_GetRegRefer((volatile uint32*)&((base)->CEOCFR0), (regIndex)))
#define CIMR(base, regIndex)        (*Adc_GetRegRefer((volatile uint32*)&((base)->CIMR0), (regIndex)))
#define DMAR(base, regIndex)        (*Adc_GetRegRefer((volatile uint32*)&((base)->DMAR0), (regIndex)))
#define PSR(base, regIndex)         (*Adc_GetRegRefer((volatile uint32*)&((base)->PSR0), (regIndex)))
#define CTR(base, regIndex)         (*Adc_GetRegRefer((volatile uint32*)&((base)->CTR0), (regIndex)))
#define NCMR(base, regIndex)        (*Adc_GetRegRefer((volatile uint32*)&((base)->NCMR0), (regIndex)))
#define JCMR(base, regIndex)        (*Adc_GetRegRefer((volatile uint32*)&((base)->JCMR0), (regIndex)))
#define CWSELR(base, regIndex)      (*Adc_GetRegRefer((volatile uint32*)&((base)->CWSELRPI[0U]), (regIndex)))
#define THRHLR(base, regIndex)      (*Adc_GetRegRefer((volatile uint32*)&((base)->THRHLR[0U]), (regIndex)))
#define CWENR(base, regIndex)       (*Adc_GetRegRefer((volatile uint32*)&((base)->CWENR0), (regIndex)))
#define AWORR(base, regIndex)       (*Adc_GetRegRefer((volatile uint32*)&((base)->AWORR0), (regIndex)))
...
/* CDR */
#define ADC_CDR_RESULT_NORMAL_TRIGGER       0x00U
#define ADC_CDR_RESULT_INJECTED_TRIGGER     0x01U
#define ADC_CDR_RESULT_CTU_TRIGGER          0x02U
