...
#define ADC_SAR_IP_AR_RELEASE_MINOR_VERSION       9
#define ADC_SAR_IP_AR_RELEASE_REVISION_VERSION    0
#define ADC_SAR_IP_SW_MAJOR_VERSION               7
 ...
 *  - ADC_SAR_IP_STATUS_CAL_ONGOING: calibration is ongoing (if async mode is active)
 */
