...
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                   7
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION                   0
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION                   1
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION           4
#define CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION           9
 ...
 * @brief         Get directed cpu Interrupt interrupt flag.
 */
extern uint32 IntCtrl_Ip_GetDirectedCpuInterruptPrivileged(IRQn_Type eIrqNumber);
#define PLATFORM_STOP_SEC_CODE
#include "Platform_MemMap.h"
#endif
