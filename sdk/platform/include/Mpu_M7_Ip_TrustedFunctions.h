...
#define CDD_PLATFORM_MPU_M7_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     9
#define CDD_PLATFORM_MPU_M7_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define CDD_PLATFORM_MPU_M7_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             7
#define CDD_PLATFORM_MPU_M7_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION             0
#define CDD_PLATFORM_MPU_M7_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION             1
 ...
 *
 * @return        uint32
 * @retval        1       if an error was present
 * @retval        0       otherwise
 *
 * @api
 *
 ...
 *
 * */
extern uint32 Mpu_M7_Ip_GetErrorDetails_Privileged(Mpu_M7_Ip_ErrorDetailsType * pErrorDetails);
