...
#define CDD_PLATFORM_MPU_M7_IP_TYPES_AR_RELEASE_MINOR_VERSION       9
#define CDD_PLATFORM_MPU_M7_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define CDD_PLATFORM_MPU_M7_IP_TYPES_SW_MAJOR_VERSION               7
#define CDD_PLATFORM_MPU_M7_IP_TYPES_SW_MINOR_VERSION               0
#define CDD_PLATFORM_MPU_M7_IP_TYPES_SW_PATCH_VERSION               1
...
/**
* @brief          Enumeration for Cortex-M7 core types.
*/
typedef enum
{
    Cortex_M7_Core0 = 0,
...
/**
* @brief          MPU_M7 configuration structure
*/
