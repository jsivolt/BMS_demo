...
#define CDD_PLATFORM_MPU_M7_IP_AR_RELEASE_MINOR_VERSION       9
#define CDD_PLATFORM_MPU_M7_IP_AR_RELEASE_REVISION_VERSION    0
#define CDD_PLATFORM_MPU_M7_IP_SW_MAJOR_VERSION               7
#define CDD_PLATFORM_MPU_M7_IP_SW_MINOR_VERSION               0
#define CDD_PLATFORM_MPU_M7_IP_SW_PATCH_VERSION               1
