...
#define COMTYPE_AR_RELEASE_MINOR_VERSION     9
#define COMTYPE_AR_RELEASE_REVISION_VERSION  0
#define COMTYPE_SW_MAJOR_VERSION             7
...
/**
 * @brief This type defines one element of a single linked list. Each element represents on part of an
 ...
 * @implements ListElemStructType_struct
 */
typedef struct ListElemStructType
{
    uint16 DataLength;                   /**< @brief Length of the data in bytes */
    uint8* DataPtr;                      /**< @brief Pointer to the data held by this list element */
    struct ListElemStructType* NextListElemPtr; /**< @brief Pointer to the next element in the list */
} ListElemStructType;
